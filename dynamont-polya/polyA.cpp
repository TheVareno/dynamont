...
// TODO do not use this, write explicit std::cin, std::cout, std::exp, std::...
using namespace std;
 ...
 */
string getBorders(const double *LPS, const double *LPL, const double *LPA, const double *LPPA, const double *LPTR, const size_t T)
{
