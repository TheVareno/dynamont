...
def setup_working_directory(working_dir=None):
...
def main(): 
    ...
    split_segment_input(input_read_data=args.fast5_path, output_path=args.output_dir, summary_file_path=args.summary_file)
