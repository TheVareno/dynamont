...
"""
- main script to find emission probabilites each state
...
def z_normalize_reads(path_to_fast5: str, read_id: str):
...
def segment_signal(path_to_polyA_annotations: str, path_to_used_read_ids_txtfile: str, path_to_fast5: str):
    ...
    with open('HMM/unused_read_ids.txt', 'r') as unused_read_ids: 
        ...
        for read_id in read_ids:
            ...
            normalized_signals = z_normalize_reads(path_to_fast5, read_id) 
